...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      console.log(error)
      alert('Erro ao cadastrar o bolão')
    }
  }
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid gap-28 grid-cols-2 items-center'>  
      <main>
        ...
        <h1 className='mt-14 text-white text-5xl font-bold leading-tight'>Crie seu próprio boção da copa e compartilhe entre amigos!</h1>
        ...
        <form onSubmit={createPool} action="" className='mt-10 flex gap-2'>
          <input 
            ...
            value={poolTitle}
            />
          <button type='submit' className='bg-yellow-500 px-6 py-4 rounded text-gray-900 font-bold uppercase text-sm hover:bg-yellow-700'>criar seu bolão</button>
        </form>
